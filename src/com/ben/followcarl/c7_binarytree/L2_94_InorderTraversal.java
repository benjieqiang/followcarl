...
public class L2_94_InorderTraversal {
    public List<Integer> inorderTraversal(TreeNode root) {
        ...
        while (root != null || !stack.isEmpty()) {
            if (root != null) {
                ...
                list.add(node.val);////步骤二，取根结点的值
                root = node.right;//步骤三，遍历右子树
            }
        }
        return list;
    }
    ...
    public static void main(String[] args) {
        ...
        L2_94_InorderTraversal l2_94_inorderTraversal = new L2_94_InorderTraversal();

        List<Integer> res = l2_94_inorderTraversal.inorderTraversal(node1);
