...
public class L4_42_trap {
    /**
     * 1.暴力解法思路；
     * 每一列雨水的高度= 该列的左侧最高柱子lHeight和右侧最高柱子rHeight相比最低的那个 再减去当前列占有的空间height[i]；
     * 按照列来计算，每一列雨水的宽度 = 1；
...
//        System.out.println(Arrays.toString(maxLeft));
        // 记录每个柱子右边柱子最大高度，从右向左遍历，始终用该数组记录
        maxRight[size - 1] = height[size - 1]; // 最后一个元素肯定是原来数组的最右边的值，没人跟他比
